...
using OpNoParamNoRet            = void(*)();
using Op8BitNoParamWithRet      = uint8_t(*)();
using Op16BitNoParamWithRet     = uint16_t(*)();
using Op8BitSingleParamNoRet    = void(*)(uint8_t);
using Op16BitSingleParamNoRet   = void(*)(uint16_t);
using Op8BitSingleParamWithRet  = uint8_t(*)(uint8_t);
using Op16BitSingleParamWithRet = uint16_t(*)(uint16_t);
using Op8BitDualParamNoRet      = void(*)(uint8_t, uint8_t);
using Op16BitDualParamNoRet     = void(*)(uint16_t, uint16_t);
using Op8BitDualParamWithRet    = uint8_t(*)(uint8_t, uint8_t);
using Op16BitDualParamWithRet   = uint16_t(*)(uint16_t, uint16_t);
...
static inline void SP( uint16_t val ) { AddressingModes::RegisterWrite<::SPtr>( val ); }
static inline uint16_t SP() { return AddressingModes::RegisterRead<::SPtr>(); }
...
template <IsByteOrWord ReturnType>
static inline ReturnType _SP_() { return AddressingModes::AddressRead<::SPtr, ReturnType>(); }
template <IsByteOrWord T>
static inline void _SP_( T val ) { AddressingModes::AddressWrite<::SPtr, T>( val ); }
template <IsByteOrWord ReturnType>
